CREATE TABLE ASIGNATURA (REFERENCIA BIGINT NOT NULL, CARACTER VARCHAR(255), CODIGO BIGINT NOT NULL, CREDITOS_PRACTICOS INTEGER NOT NULL, CREDITOS_TEORICOS INTEGER NOT NULL, CREDITOS_TOTALES INTEGER NOT NULL, CURSO VARCHAR(255), DURACION VARCHAR(255), IDIOMAS VARCHAR(255), NOMBRE VARCHAR(255) NOT NULL, OFERTA INTEGER NOT NULL, UNIDAD_TEMPORAL VARCHAR(255), GRUPO_ASIGNATURA_CURSO_ACADEMICO VARCHAR(255), PRIMARY KEY (REFERENCIA))
