...
CREATE TABLE CENTRO (ID BIGINT NOT NULL, TLF_CONSERJERIA BIGINT, DIRECCION VARCHAR(255) NOT NULL, NOMBRE VARCHAR(255) NOT NULL, PRIMARY KEY (ID))
CREATE TABLE GRUPO_ASIGNATURA (CURSO_ACADEMICO VARCHAR(255) NOT NULL, OFERTA VARCHAR(255), PRIMARY KEY (CURSO_ACADEMICO))
CREATE TABLE GRUPO (ID BIGINT NOT NULL, ASIGNAR TINYINT(1) default 0, CURSO VARCHAR(255) NOT NULL, INGLES TINYINT(1) default 0 NOT NULL, LETRA VARCHAR(255) NOT NULL, PLAZAS BIGINT, TURNO_MAÑANA_TARDE VARCHAR(255) NOT NULL, VISIBLE TINYINT(1) default 0, GRUPO_ID BIGINT, GRUPO_ASIGNATURA_CURSO_ACADEMICO VARCHAR(255), PRIMARY KEY (ID))
CREATE TABLE MATRICULA (ID BIGINT NOT NULL, CURSO_ACADEMICO VARCHAR(255) NOT NULL, ESTADO VARCHAR(255) NOT NULL, FECHA_MATRICULA DATE NOT NULL, NUEVO_INGRESO TINYINT(1) default 0, NUM_ARCHIVO BIGINT, TURNO_PREFERENTE VARCHAR(255), ASIGNATURAS_MATRICULA_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE EXPEDIENTE (NUM_EXPEDIENTE BIGINT NOT NULL, ACTIVO TINYINT(1) default 0, NOTA_MEDIA_PROVISIONAL BIGINT, ENCUESTAS_ID INTEGER, MATRICULAS_ID BIGINT, PRIMARY KEY (NUM_EXPEDIENTE))
CREATE TABLE ASIGNATURAS_MATRICULA (ID BIGINT NOT NULL, CALIFICACION INTEGER, MATRICULAS_ID BIGINT, PRIMARY KEY (ID))
CREATE TABLE ENCUESTA (ID INTEGER NOT NULL, FECHA_ENVIO DATE NOT NULL, PRIMARY KEY (ID))
CREATE TABLE ALUMNO (ID BIGINT NOT NULL, CP VARCHAR(255), DNI VARCHAR(255) NOT NULL, APELLIDO1 VARCHAR(255) NOT NULL, APELLIDO2 VARCHAR(255), DIRECCION VARCHAR(255), EMAIL_I VARCHAR(255) NOT NULL, EMAIL_P VARCHAR(255), LOCALIDAD VARCHAR(255), MOVIL BIGINT, NOMBRE VARCHAR(255) NOT NULL, PROVINCIA VARCHAR(255), TELEFONO BIGINT, PRIMARY KEY (ID))
...
ALTER TABLE EXPEDIENTE ADD CONSTRAINT FK_EXPEDIENTE_ENCUESTAS_ID FOREIGN KEY (ENCUESTAS_ID) REFERENCES ENCUESTA (ID)
ALTER TABLE EXPEDIENTE ADD CONSTRAINT FK_EXPEDIENTE_MATRICULAS_ID FOREIGN KEY (MATRICULAS_ID) REFERENCES MATRICULA (ID)
ALTER TABLE ASIGNATURAS_MATRICULA ADD CONSTRAINT FK_ASIGNATURAS_MATRICULA_MATRICULAS_ID FOREIGN KEY (MATRICULAS_ID) REFERENCES MATRICULA (ID)
